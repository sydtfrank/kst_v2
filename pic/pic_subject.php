			...
			<section>
				<nav class="menu">
					<ul>
						...
						<li>
							<a href="pic_subject.php" class="active">出題圖片</a>
						</li>
						<li>
			...
			<div class="func">
				<section>
					<div class="col">
						<ul class="cat_list">
							<li class="nav_geo">
								<a href="pic_subject.php">地理</a>
							</li>
							<li class="nav_history">
								<a href="pic_subject.php">歷史</a>
							</li>
							<li class="nav_society">
								<a href="pic_subject.php" class="active">公民與社會</a>
							</li>
						</ul>
					</div>
					<div class="col">
						<form method="post" onSubmit="return form_send();" action="pic_subject_result.php">
							<div class="query_box">
				...
				<section>
					<div class="book_list">
						<span>第</span>
						<a href="javascript:void(0);" onclick="show_lesson(this, 'book_1')">1</a>
						<a href="javascript:void(0);" onclick="show_lesson(this, 'book_2')">2</a>
						<a href="javascript:void(0);" onclick="show_lesson(this, 'book_3')" class="active">3</a>
					...
					<div class="lesson_list">
						<ul class="book_1">
							<li><a href="pic_subject.php">第1課</a></li>
							<li><a href="pic_subject.php">第2課</a></li>
							<li class="active"><a href="pic_subject.php">第3課</a></li>
							<li><a href="pic_subject.php">第4課</a></li>
							<li><a href="pic_subject.php">第5課</a></li>
							<li><a href="pic_subject.php">第6課</a></li>
						</ul>
						<ul class="book_2">
							<li><a href="pic_subject.php">第1課</a></li>
							<li><a href="pic_subject.php">第2課</a></li>
