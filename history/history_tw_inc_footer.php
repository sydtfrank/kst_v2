...
<!-- 導航區 開始 -->
<div class="nav_box">
	<div><img src="templates/images/menu_01.svg"></div>
	<a href="history_tw.php#1">史前時代</a>
	<a href="history_tw.php#2">大航海時代</a>
	<a href="history_tw.php#3">清帝國時期</a>
	<a href="history_tw.php#4">日治時期</a>
	<a href="history_tw.php#5">中華民國在臺灣</a>
...
$(document).ready(function () {
	//台灣史
	if ($("body.history_tw").length) {
		var new_html = '';
		new_html += '<div class="L"><img src="templates/images/top_bg_1.png"></div>';
		new_html += '<div class="M"><img src="templates/images/top_bg_2.png"></div>';
		new_html += '<div class="S"><img src="templates/images/top_bg_3.png"></div>';
